...
from pyb_solo_simulator import pybullet_simulator, TorqueControlLoop
...
if __name__ == "__main__":
    ...
    pyb_sim = pybullet_simulator(dt=DT, q_init=q_init, root_init = root_init, force_control = True)

    print("Press enter to start the motion")
    input()
    # Start the control loop:
    TorqueControlLoop(pyb_sim, DT, q_t, dq_t, tau_t)
